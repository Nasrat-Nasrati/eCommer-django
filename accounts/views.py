...
from .forms import RagistrationForm,UserForm,UserProfileForm
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exist:
                    ...
                    #geting product variation by product id
                    product_variation=[]
...
def edit_profile(request):
    ...
    if request.method =='POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            user_form.save()
            profile_form.save()
            messages.success(request,'Your profile has been updated successfull')
...
def change_password(request):
     if request.method=='POST':
         ...
         if new_password == confirm_password:
             ...
             messages.error(request,'Sorry Password dose not match please try again!')
             return redirect('change_password')
